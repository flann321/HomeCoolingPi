...
class Nest:
	...
	def get_fan_state(self):
		return n.status['shared'][n.serial]['hvac_fan_state']

	def get_ac_state(self):
		return n.status['shared'][n.serial]['hvac_ac_state']

	def get_heater_state(self):
		return n.status['shared'][n.serial]['hvac_heater_state']

    def get_curhumidity(self):
    	humidity = self.status["device"][self.serial]["current_humidity"]
